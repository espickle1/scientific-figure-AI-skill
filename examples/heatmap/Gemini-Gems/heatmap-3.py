...
CONFIG = {
    ...
    "dpi": 300,
    "title": r"Metabolic Output Data for $\it{B.\,cereus}$", # \, reduces spacing compared to \ 
    "title_size": 9,
    "label_size": 7,
    "tick_size": 7,
    "cbar_tick_size": 3.5, # Decreased by 50% from 7
    "font_family": ["Arial", "Helvetica", "DejaVu Sans", "sans-serif"],
    "colors": ["green", "white", "red"],
    "border_width": 0.5, # Decreased by 50% from 1.0
...
plt.rcParams['axes.unicode_minus'] = False # Use short dash (ASCII hyphen) for negative signs
