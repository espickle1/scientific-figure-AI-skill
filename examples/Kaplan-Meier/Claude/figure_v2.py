...
CONFIG = {
    ...
    "group_col":    "Treatment",
    "groups":       ["GST", "Vac"],
    "colors":       ["#0072B2", "#CC0000"],   # blue GST, red Vac
...
ax.set_xticks(range(0, CONFIG["x_max"] + 1, 4))

ax.set_xlabel("Days post-vaccination", fontsize=7, labelpad=4)
ax.set_ylabel("Mice surviving", fontsize=7, labelpad=4)
...
ax.set_title("Mice Survival Curve: Iron Uptake System Vaccine",
             fontsize=12, fontname=FONT, pad=6)
