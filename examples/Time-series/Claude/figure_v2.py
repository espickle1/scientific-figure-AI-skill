...
CONFIG = {
    ...
    "legend_size":  6,
    "series":       ["A1", "B1", "C1", "D1"],
    "colors":       ["#0072B2", "#009E73", "#CC79A7", "#D55E00"],  # blue, green, violet, red
    "markers":      ["o", "o", "o", "o"],   # closed circle for all
    "font_axis_title": 8,
    "font_plot_title": 10,
...
ax.tick_params(width=0.6, length=3, direction="out", labelsize=8)
