# Figure v2 | X-Y scatter of OD600 by mg/mL | black/orange
...
# Axes ticks: No ticks at x=y=0, specific steps
...
# Legend: Lower left corner corresponding to x=0.1, y=0.05
# Font size -25% (0.75x), frame border 50% (lw=0.5) and grey
leg = ax.legend(loc="lower left", bbox_to_anchor=(0.1, 0.05), bbox_transform=ax.transData, 
